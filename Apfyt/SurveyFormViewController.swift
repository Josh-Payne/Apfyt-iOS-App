...
class ViewController: UIViewController, ORKTaskViewControllerDelegate {
    ...
    let mcChoices = ["I found out through social media", "I found out through television", "A friend told me"]
...
//        }
        ...
        style = ["rate", "text", "rate", "number", "rate"]
  ...
  func taskViewController(_ taskViewController: ORKTaskViewController, didFinishWith reason: ORKTaskViewControllerFinishReason, error: Error?) {
    ...
    var SurveyTask: ORKOrderedTask {
        ...
        let nameQuestionStepTitle = NSLocalizedString(questionsArray[questionNumber], comment: "")
            ...
            if style[elem] == "rate" {
                ...
                questionNumber+=1
                    ...
                    if style[elem] == "number" {
                        let formStepImage = ORKFormStep(identifier: "Question " + String(questionNumber), title: "How likely would you be to recommend us to a friend?", text: "")
                       // let colorQuestionStepTitle = NSLocalizedString(questionsArray[elem], comment: "")
        ...
        if true { //style[elem] == "multipleChoice" {
            let formStepMC = ORKFormStep(identifier: "Question " + String(questionNumber), title: "Where did you hear about us?", text: "")
